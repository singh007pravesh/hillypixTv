...
import { View, StyleSheet, Text, TouchableOpacity, ActivityIndicator, Button, Pressable,StatusBar , Platform, SafeAreaView} from 'react-native';
...
const VideoDetail = (props) => {
    ...
    return (
        <SafeAreaView style={styles.containerMain} edges={['right' ]}>
...
const styles = StyleSheet.create({
    containerMain: {
        ...
        paddingTop: 0, // Adjust as per your design
      },
    container: {
        flex: 1,
        backgroundColor: '#000',
